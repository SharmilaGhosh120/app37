...
def init_db():
    try:
        ...
        if not all(col in project_columns for col in required_project_columns):
            logger.warning("Projects table schema incorrect. Recreating table.")
        ...
        # Insert initial admin user (to be secured post-deployment)
...
def bulk_register_users(csv_file):
    try:
        ...
        for row in reader:
            ...
            password = 'default123'  # Secure post-deployment
